			...
			<div id="" class="widefat sortable-slides-list-item postbox">
				...
				<div class="inside">
					...
					<div class="slideshow-group">
						...
						<a href="<?php echo $editUrl; ?>" title="<?php esc_html_e( 'Edit', 'slideshow-jquery-image-gallery' ); ?> &#34;<?php echo $attachment->post_title; ?>&#34;">
					...
					<div class="slideshow-group">
						...
						<select name="<?php echo $name; ?>[urlTarget]" class="slideshow-right">
							<option value="_self" <?php selected( '_self', $target ); ?>><?php esc_html_e( 'Same window', 'slideshow-jquery-image-gallery' ); ?></option>
							<option value="_blank" <?php selected( '_blank', $target ); ?>><?php esc_html_e( 'New window', 'slideshow-jquery-image-gallery' ); ?></option>
						</select>
						<div class="clear"></div>
