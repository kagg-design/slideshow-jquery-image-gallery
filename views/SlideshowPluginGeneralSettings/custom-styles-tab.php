...
if ( $data instanceof stdClass ) :
	...
	<div class="custom-styles-tab feature-filter" style="float: left; display: none;">
		<div class="styles-list">
			...
			<p>
				<b><?php esc_html_e( 'Default stylesheets', 'slideshow-jquery-image-gallery' ); ?></b>
			</p>
			...
			<ul class="default-styles-list">
				...
				<?php if ( is_array( $defaultStyles ) ) : ?>
					<?php foreach ( $defaultStyles as $defaultStyleKey => $defaultStyleValues ) : ?>
						...
						<?php
						if ( ! isset( $defaultStyleValues['style'] ) || empty( $defaultStyleValues['style'] ) ) {
							continue;} // Continue if style is not set or empty
						?>
					...
					<li>
						<span class="style-title"><?php echo ( isset( $defaultStyleValues['name'] ) ) ? htmlspecialchars( $defaultStyleValues['name'] ) : __( 'Untitled' ); ?></span>
							<span
								...
								title="<?php esc_html_e( 'Create a new custom style from this style', 'slideshow-jquery-image-gallery' ); ?>"
								>
								<?php esc_html_e( 'Customize', 'slideshow-jquery-image-gallery' ); ?> &raquo;
							</span>
			...
			<p>
				<b><?php esc_html_e( 'Custom stylesheets', 'slideshow-jquery-image-gallery' ); ?></b>
			</p>
			...
			<ul class="custom-styles-list">
					...
					<li>
						<span class="style-title"><?php echo htmlspecialchars( $customStyleKeyName ); ?></span>
							...
							<span
								...
								>
								<?php esc_html_e( 'Edit', 'slideshow-jquery-image-gallery' ); ?> &raquo;
							</span>
						...
						<span style="float: right;">&#124;</span>
							...
							<span
								...
								title="<?php esc_html_e( 'Delete this style', 'slideshow-jquery-image-gallery' ); ?>"
								>
								<?php esc_html_e( 'Delete', 'slideshow-jquery-image-gallery' ); ?>
							</span>
				...
				<li class="no-custom-styles-found">
					<?php esc_html_e( "Click 'Customize' to create a new custom stylesheet." ); ?>
				</li>
	...
	<div class="custom-styles-tab feature-filter" style="display: none;">
		<div class="style-editors">
			...
			<p>
				<b><?php esc_html_e( 'Custom style editor', 'slideshow-jquery-image-gallery' ); ?></b>
			</p>

			<p class="style-editor">
				<?php esc_html_e( 'Select a stylesheet to start customizing it.', 'slideshow-jquery-image-gallery' ); ?>
			</p>
		...
		<div class="custom-style-templates" style="display: none;">
			...
			<li class="custom-styles-list-item">
				<span class="style-title"></span>
						...
						<span
							class="style-action"
							title="<?php esc_html_e( 'Edit this style', 'slideshow-jquery-image-gallery' ); ?>"
							>
							<?php esc_html_e( 'Edit', 'slideshow-jquery-image-gallery' ); ?> &raquo;
						</span>
			...
			<div class="style-editor" style="display: none;">
				...
				<p>
					<i><?php esc_html_e( 'Title', 'slideshow-jquery-image-gallery' ); ?></i><br />
					<input
						type="text"
				...
				<p>
					<i><?php esc_html_e( 'Style', 'slideshow-jquery-image-gallery' ); ?></i><br />
					<textarea
