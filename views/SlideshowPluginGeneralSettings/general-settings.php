	...
	<div class="wrap">
		<form method="post" action="options.php">
			...
			<h2 class="nav-tab-wrapper">
				<a href="#general-settings-tab" class="nav-tab nav-tab-active"><?php esc_html_e( 'General Settings', 'slideshow-jquery-image-gallery' ); ?></a>
				<a href="#default-slideshow-settings-tab" class="nav-tab"><?php esc_html_e( 'Default Slideshow Settings', 'slideshow-jquery-image-gallery' ); ?></a>
				<a href="#custom-styles-tab" class="nav-tab"><?php esc_html_e( 'Custom Styles', 'slideshow-jquery-image-gallery' ); ?></a>
