<?php if ( $data instanceof stdClass ) : ?>
	...
	<p>
		<label for="<?php echo $data->widget->get_field_id( 'title' ); ?>"><?php esc_html_e( 'Title', 'slideshow-jquery-image-gallery' ); ?></label>
	...
	<p>
		<label for="<?php echo $data->widget->get_field_id( 'slideshowId' ); ?>"><?php esc_html_e( 'Slideshow', 'slideshow-jquery-image-gallery' ); ?></label>
		<select class="widefat" id="<?php echo $data->widget->get_field_id( 'slideshowId' ); ?>" name="<?php echo $data->widget->get_field_name( 'slideshowId' ); ?>" value="<?php echo ( is_numeric( $data->instance['slideshowId'] ) ) ? $data->instance['slideshowId'] : ''; ?>" style="width:100%">
			<option value="-1" <?php selected( $data->instance['slideshowId'], -1 ); ?>><?php esc_html_e( 'Random Slideshow', 'slideshow-jquery-image-gallery' ); ?></option>
